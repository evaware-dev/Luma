...
object RenderTestApp {
    ...
    private fun captureStateLegacy(snapshot: GlStateSnapshot): GlStateSnapshot {
    ...
    private fun runBenchmark() {
        ...
        repeat(5000) { i ->
            ...
            if (i < 200) Texture(warmUp).apply { load() }.close()
        }
        ...
        repeat(300) { Texture(img).apply { load() }.close() }
